...
def run_optimization_for_data(data_idx: str, gpu_id: int, stage: int = None):
    ...
    for side in sides:
        ...
        # 设置contact data路径
        contact_data_path = f"/home/zxlei/data/humanoid/Maniptrans_YS/data/contacts_{side}/humoto/contacts_{data_idx}.pkl"
        ...
        try:
            result = subprocess.run(cmd, env=env, check=True, cwd="/home/zxlei/data/humanoid/Maniptrans_YS")
...
def main():
    ...
    parser.add_argument("--gpu_ids", type=str, default="0,1,2,3,4,5,6,7",
                       help="可用的GPU ID列表，用逗号分隔 (默认: 0,1,2,3,4,5,6,7)")
