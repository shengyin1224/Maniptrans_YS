...
class OakInk2DatasetDexHandLH(ManipData):
    ...
    def __getitem__(self, index):
        ...
        obj_mesh = load_obj_map(os.path.join(self.data_dir, "coacd_object_preview_new", "align_ds"), object_list)
        ...
        obj_urdf_path_dir = obj_mesh_path_dir.replace(
            "data/OakInk-v2/object_preview", "data/OakInk-v2/coacd_object_preview_new"
        )
